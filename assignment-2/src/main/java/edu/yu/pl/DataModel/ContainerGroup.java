...
public class ContainerGroup {
    ...
    /**
     * Deploys all containers in the group.
     * This method iterates through each container in the group and calls its deploy method.
     */
    public void deploy() {
        System.out.println("Deploying Container Group: " + groupName);
